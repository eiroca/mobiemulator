...
final class d implements Enumeration {
  ...
  d(final FileConnectionImpl paramFileConnectionImpl, final File[] paramArrayOfFile) {
  ...
  public final Object nextElement() {
    if (jdField_a_of_type_Int < jdField_a_of_type_ArrayOfJavaIoFile.length) { return jdField_a_of_type_ArrayOfJavaIoFile[jdField_a_of_type_Int].getName()
