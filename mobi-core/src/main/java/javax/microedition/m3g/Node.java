...
public abstract class Node extends Transformable {
  ...
  public void setAlignment(final Node zReference, final int zTarget, final Node yReference, final int yTarget) {
  ...
  public Node getAlignmentReference(final int axis) {
    final Node __res = (Node)Engine.instantiateJavaPeer(getAlignmentReferenceImpl(axis));
    return __res;
  }
