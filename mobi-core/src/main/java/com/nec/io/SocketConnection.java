...
public abstract interface SocketConnection extends StreamConnection {
  ...
  public abstract void setSocketOption(byte paramByte, int paramInt) throws IOException;

  public abstract int getSocketOption(byte paramByte) throws IOException;
