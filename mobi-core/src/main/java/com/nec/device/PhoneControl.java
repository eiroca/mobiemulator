...
public final class PhoneControl {
  ...
  public static final void setAttribute(final int i, final int j) throws IllegalArgumentException {
  }

  public static final int getAttribute(final int dev) throws IllegalArgumentException {
    return 0;
  }

  public static final boolean isAvailable(final int dev) throws IllegalArgumentException {
    return false;
  }

  private static boolean _isDevice(final int dev) {
    return false;
  }

  private static boolean _isAttribute(final int attr) {
    return false;
  }
