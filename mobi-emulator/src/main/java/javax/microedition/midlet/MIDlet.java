...
public abstract class MIDlet {
  ...
  /**
   * Public method that allows the midlet manager to call the protected startApp on a midlet
   */
  public void amsStartApp(final MidletListener midletListener) {
    try {
  ...
  /**
   * Public method that allows the midlet manager to call the protected pauseApp on a midlet
   */
  ...
  /**
   * Public method that allows the midlet manager to call the protected destroyApp on a midlet
   */
  public void amsDestroyApp(final boolean unconditional) {
    try {
  ...
  /**
   * Used by an MIDlet to notify the application management software that it has entered into the
   * Destroyed state.
   */
  ...
  /**
   * Notifies the application management software that the MIDlet does not want to be active and has
  ...
  /**
   * Provides a MIDlet with a mechanism to indicate that it is interested in entering the Active
   * state.
   */
  ...
  public final boolean platformRequest(final String URL) throws ConnectionNotFoundException {
    ...
    try {
      final String str = "rundll32 url.dll,FileProtocolHandler " + URL;
  ...
  /**
   * Provides a MIDlet with a mechanism to retrieve named properties from the application management
   * software.
   */
