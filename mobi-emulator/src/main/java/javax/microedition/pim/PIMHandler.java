...
public abstract class PIMHandler {
  ...
  public static PIMHandler getInstance() {
    if (PIMHandler.instance == null) {
      try {
        PIMHandler.instance = (PIMHandler)Class.forName("javax.microedition.pim.DefaultPIMHandler").newInstance();
      }
