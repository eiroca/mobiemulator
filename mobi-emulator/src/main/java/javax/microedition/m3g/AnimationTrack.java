...
public class AnimationTrack extends Object3D {
  ...
  AnimationTrack(final int handle) {
    super(handle);
  }

  public AnimationTrack(final KeyframeSequence sequence, final int property) {
    this(AnimationTrack.create(sequence, property));
    Engine.addJavaPeer(swerveHandle, this);
    ii = (getClass() != AnimationTrack.class);
