...
public class Graphics3D {
  ...
  public void bind(Graphics paramGraphics) {
  }
  ...
  public void release(Graphics paramGraphics) {
  }

  public void release(Object paramObject) {
  }

  public void renderPrimitives(Texture paramTexture, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D, int paramInt3, int paramInt4, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int[] paramArrayOfInt3, int[] paramArrayOfInt4) {
  }

  /**
   * @deprecated
   */
  public void renderPrimitives(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D, int paramInt3, int paramInt4, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int[] paramArrayOfInt3, int[] paramArrayOfInt4) {
  }

  /**
   * @deprecated
   */
  public void drawCommandList(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D, int[] paramArrayOfInt) {
  }

  public void drawCommandList(Texture[] paramArrayOfTexture, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D, int[] paramArrayOfInt) {
  }

  public void drawCommandList(Texture paramTexture, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D, int[] paramArrayOfInt) {
  }

  public void renderFigure(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D) {
  }

  public void drawFigure(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D) {
  }
