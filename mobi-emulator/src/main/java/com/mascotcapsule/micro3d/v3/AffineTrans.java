...
public class AffineTrans {
  ...
  public AffineTrans(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12) {
  }
  ...
  public final void set(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, int paramInt11, int paramInt12) {
  }
  ...
  public final Vector3D transform(Vector3D paramVector3D) {
    return null;
  }
  ...
  public final void setRotation(Vector3D paramVector3D, int paramInt) {
  }
  ...
  public final void lookAt(Vector3D paramVector3D1, Vector3D paramVector3D2, Vector3D paramVector3D3) {
  }
}
