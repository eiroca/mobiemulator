...
public abstract interface Graphics3D {
  ...
  public abstract void renderPrimitives(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D, int paramInt3, int paramInt4, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int[] paramArrayOfInt3, int[] paramArrayOfInt4);

  public abstract void drawCommandList(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D, int[] paramArrayOfInt);

  public abstract void renderFigure(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D);

  public abstract void flush();

  public abstract void drawFigure(Figure paramFigure, int paramInt1, int paramInt2, FigureLayout paramFigureLayout, Effect3D paramEffect3D);
