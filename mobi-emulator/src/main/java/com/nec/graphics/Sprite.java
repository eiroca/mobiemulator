...
public final class Sprite {
  ...
  public Sprite(Image image, int x, int y, boolean visible) throws IllegalArgumentException, NullPointerException {
    this.image = null;
  }
  ...
  public void setImage(Image image1) throws NullPointerException {
  }
