...
public final class PhoneControl {
  ...
  public static final void setAttribute(int i, int j) throws IllegalArgumentException {
  }

  public static final int getAttribute(int dev) throws IllegalArgumentException {
    return 0;
  }

  public static final boolean isAvailable(int dev) throws IllegalArgumentException {
    return false;
  }
