...
/*
 * Emulatorge this template, choose Tools | Templates and open the template in the editor.
 */
...
public final class JarResources {
  ...
  public byte[] getResource(final String name) {
     ...
     */
    if (htJarContents.get(name) == null) { return null; }
  ...
  /**
   * Is a test driver. Given a jar file and a resource name, it trys to extract the resource and
   * then tells us whether it could or not.
   *
   * <strong>Example</strong> Let's say you have a JAR file which jarred up a bunch of gif image
   * files. Now, by using JarResources, you could extract, create, and display those images
   * on-the-fly.
   *
   * <pre>
   *     ...
  ...
  public void setJarCache(final Hashtable jarcache) {
