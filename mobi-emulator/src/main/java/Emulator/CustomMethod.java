...
public class CustomMethod {
  ...
  public static void beginMethod(final String methodPath) {
  ...
  public static void endMethod(final String methodPath) {
  ...
  public static void newInstance(final int opcode, final String type) {
